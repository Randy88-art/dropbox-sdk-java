...
public enum EventTypeArg {
    ...
    static class Serializer extends UnionSerializer<EventTypeArg> {
        ...
        public void serialize(EventTypeArg value, JsonGenerator g) throws IOException, JsonGenerationException {
            switch (value) {
                ...
                case RANSOMWARE_RESTORE_PROCESS_COMPLETED: {
                    g.writeString("ransomware_restore_process_completed");
                    break;
                }
                case RANSOMWARE_RESTORE_PROCESS_STARTED: {
                    g.writeString("ransomware_restore_process_started");
                    break;
                }
                ...
                case TEAM_ENCRYPTION_KEY_DELETE_KEY: {
                    g.writeString("team_encryption_key_delete_key");
                    break;
                }
                case TEAM_ENCRYPTION_KEY_DISABLE_KEY: {
                    g.writeString("team_encryption_key_disable_key");
                    break;
                }
                case TEAM_ENCRYPTION_KEY_ENABLE_KEY: {
                    g.writeString("team_encryption_key_enable_key");
                    break;
                }
                case TEAM_ENCRYPTION_KEY_ROTATE_KEY: {
                    g.writeString("team_encryption_key_rotate_key");
                    break;
                }
                case TEAM_ENCRYPTION_KEY_SCHEDULE_KEY_DELETION: {
                    g.writeString("team_encryption_key_schedule_key_deletion");
                    break;
                }
                ...
                case FILE_ADD_FROM_AUTOMATION: {
                    g.writeString("file_add_from_automation");
                    break;
                }
                case FILE_COPY: {
                ...
                case BACKUP_ADMIN_INVITATION_SENT: {
                    g.writeString("backup_admin_invitation_sent");
                    break;
                }
                case BACKUP_INVITATION_OPENED: {
                    g.writeString("backup_invitation_opened");
                    break;
                }
                ...
                case REPLAY_FILE_SHARED_LINK_MODIFIED: {
                    g.writeString("replay_file_shared_link_modified");
                    break;
                }
                case REPLAY_PROJECT_TEAM_ADD: {
                    g.writeString("replay_project_team_add");
                    break;
                }
        ...
        public EventTypeArg deserialize(JsonParser p) throws IOException, JsonParseException {
            ...
            else if ("ransomware_restore_process_completed".equals(tag)) {
                value = EventTypeArg.RANSOMWARE_RESTORE_PROCESS_COMPLETED;
            }
            else if ("ransomware_restore_process_started".equals(tag)) {
                value = EventTypeArg.RANSOMWARE_RESTORE_PROCESS_STARTED;
            }
            ...
            else if ("team_encryption_key_disable_key".equals(tag)) {
                value = EventTypeArg.TEAM_ENCRYPTION_KEY_DISABLE_KEY;
            }
            else if ("team_encryption_key_enable_key".equals(tag)) {
                value = EventTypeArg.TEAM_ENCRYPTION_KEY_ENABLE_KEY;
            }
            else if ("team_encryption_key_rotate_key".equals(tag)) {
                value = EventTypeArg.TEAM_ENCRYPTION_KEY_ROTATE_KEY;
            }
            else if ("team_encryption_key_schedule_key_deletion".equals(tag)) {
                value = EventTypeArg.TEAM_ENCRYPTION_KEY_SCHEDULE_KEY_DELETION;
            }
            ...
            else if ("file_add_from_automation".equals(tag)) {
                value = EventTypeArg.FILE_ADD_FROM_AUTOMATION;
            }
            ...
            else if ("backup_invitation_opened".equals(tag)) {
                value = EventTypeArg.BACKUP_INVITATION_OPENED;
            }
            ...
            else if ("ransomware_alert_create_report".equals(tag)) {
                value = EventTypeArg.RANSOMWARE_ALERT_CREATE_REPORT;
            }
            ...
            else if ("replay_file_shared_link_created".equals(tag)) {
                value = EventTypeArg.REPLAY_FILE_SHARED_LINK_CREATED;
            }
            else if ("replay_file_shared_link_modified".equals(tag)) {
                value = EventTypeArg.REPLAY_FILE_SHARED_LINK_MODIFIED;
            }
            else if ("replay_project_team_add".equals(tag)) {
                value = EventTypeArg.REPLAY_PROJECT_TEAM_ADD;
            }
