...
public class MembersDeactivateBaseArg {
    ...
    public boolean equals(Object obj) {
        ...
        // be careful with inheritance
            ...
            MembersDeactivateBaseArg other = (MembersDeactivateBaseArg) obj;
    ...
    private static class Serializer extends StructSerializer<MembersDeactivateBaseArg> {
        ...
        @Override
        public void serialize(MembersDeactivateBaseArg value, JsonGenerator g, boolean collapse) throws IOException, JsonGenerationException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public MembersDeactivateBaseArg deserialize(JsonParser p, boolean collapsed) throws IOException, JsonParseException {
            MembersDeactivateBaseArg value;
            String tag = null;
            if (!collapsed) {
                expectStartObject(p);
                tag = readTag(p);
            ...
            if (tag == null) {
                ...
                value = new MembersDeactivateBaseArg(f_user);
            }
            else {
